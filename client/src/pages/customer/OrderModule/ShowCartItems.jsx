                                ...
                                <div>
                                    <div className="text-lg font-semibold flex gap-2 flex-col">
                                        ...
                                        <div
                                            ...
                                            {item.quantity > 1 ?
                                                <p onClick={() => decreaseQuantity(user._id, item._id, cartUpdated, setCartUpdated)}
                                                   className="cursor-pointer basis-1/3 text-left">-</p> :
                                                <p onClick={() => deleteCartItem(user._id, item._id, cartUpdated, setCartUpdated)}
                                                   className="cursor-pointer basis-1/3"><Trash2
                                                    className="w-4 h-4 text-sm"/>
                                                </p>}
                                            <p className="basis-1/3 text-center">{item.quantity}</p>
                                            <p onClick={() => increaseQuantity(user._id, item._id, cartUpdated, setCartUpdated)}
