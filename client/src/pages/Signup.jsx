...
const Signup = () => {
    ...
    shadow-2xl transition-all duration-500 ease-out">
            <form onSubmit={onSubmit} className="flex flex-col gap-2 p-4 mt-10 font-mono ">
                ...
                <input type={showpass ? "password" : "text"} placeholder="Enter your password" className="border-b-2 border-black py-2 px-4 focus:outline-0"
                ...
                <input type="text" placeholder="Enter your First Name" className="border-b-2 border-black py-2 px-4 focus:outline-0 capitalize"
