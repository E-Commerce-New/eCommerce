        ...
        <main className="bg-[#0f0f0f] text-white min-h-screen font-sans">
            ...
            <section className="text-center py-24 px-6 md:px-16">
                ...
                <div className="mt-10">
                    <a
                        href="#contact"
                        className="text-lg px-6 py-4 bg-indigo-600 hover:bg-indigo-700 rounded-xl"
                    >
                        Get Started Free
                    </a>
                </div>
            ...
            <section className="py-16 px-6 md:px-20 bg-[#1a1a1a]">
                <h2 className="text-4xl font-bold mb-10 text-center">Your Journey With Us</h2>
            ...
            <section className="py-20 px-6 md:px-20 bg-[#0f0f0f]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="bg-[#1f1f1f] p-6 rounded-2xl shadow-md text-center">
            ...
            <section className="py-20 px-6 md:px-20 bg-[#1a1a1a] text-center">
                <h2 className="text-4xl font-bold mb-10">Transparent Pricing</h2>
            ...
            <section className="bg-[#0f0f0f] text-white py-20 px-6 md:px-20">
                ...
                <form ref={form} onSubmit={sendMail} className="max-w-2xl mx-auto space-y-6">
                    <div>
