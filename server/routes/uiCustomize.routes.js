...
router.get('/get', async (req, res) => {
    try {
        const uiCustomize = await UiCustomize.findOne(); // Only one document exists
...
router.delete('/deleteBanner/:index', async (req, res) => {
...
router.post('/addMainProducts', async (req, res) => {
