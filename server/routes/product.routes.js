...
const {getProductById, deleteProduct, updateProduct, getProducts, createProducts , addCategory, getCategories , deleteCategory , getProductByIds} = require('../controllers/product.controller')
